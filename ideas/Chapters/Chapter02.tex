...
An overall makeover for the weapon that gives it a speciality. This mod cannot be detached, but is applicable to all weapons. The makeover changes its name and gives it a special ability that uses an extensive amount of a specific limited resource. 
