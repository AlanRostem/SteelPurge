...
Completing a level while having a newly discovered weapon in your inventory gives you the opportunity to unlock that weapon and have the ability to call in a supply drop with that weapon in it. It costs one Evo Core to deploy a weapon.
