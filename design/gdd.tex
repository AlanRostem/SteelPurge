...
Damaged obstacles are destructible and grant scrap upon taking damage and when destroyed, similar to how enemies work. They are used to add a fun way to progress the level and reward some scrap. 
