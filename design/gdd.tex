...
\subsubsection{General Areas (Mixed with platforming, combat and puzzle)}

WIP: This subsection describes the general areas the player will encounter as a continuous pace of the level. Since this game is a sidescrolling platformer, there will obviously be platforming on the levels. This includes simple parkour by jumping and using other movement mechanics. In the section describing all the game objects, some objects will be used to help the player either in combat or to complete mini-puzzles to unlock secrets or progress the level.
