...
The game is a 2D sidescroller containing four level per eight worlds where each level has a unique objective to complete per world. The objectives range from reaching the end of the level, collecting items and making sure you don't lose them, planting a bomb and last, but not least, defeating a boss.
