...
This enemy is the exact same as the regular MXD-Hornet, but it can only take critical hit damage. The Firewall .127 upgrade is the only weapon that can directly damage this enemy. 
