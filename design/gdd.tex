...
Key objects are objects that can trigger a special effect using a specific weapon's shots. They are meant to be used in combat and unlock secrets and give each weapon a unique purpose. 
